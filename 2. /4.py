...
numeroTelefono = input("Introduce un número de telefono con su prefijo y extensión ")
print(f"El numero de telefono sin extension es: {numeroTelefono.split('-')[1]}") # split separa: en este caso hasta - y luego coge la segunda parte